...
<div class="w-screen min-h-screen flex flex-col bg-[#111111] font-poppins text-white p-5 md:p-10 justify-center items-center">
    <div class="flex flex-col md:flex-row justify-center items-center">
        <div class="flex flex-col w-full md:w-1/2 gap-5 p-5">
            ...
            <div class=" leading-7 font-light">{desc}</div>
            <div class="flex flex-row justify-around items-start">
                <div class="flex flex-col justify-center items-center">
                    <div class="text-orange-500 font-bold text-3xl">45+</div>
                    <div class="text-center">Active Members</div>
                </div>
                <div class="flex flex-col justify-center items-center">
                    <div class="text-orange-500 font-bold text-3xl">50+</div>
                    <div class="text-center">Projects Completed</div>
                </div>
                <div class="flex flex-col justify-center items-center">
                    <div class="text-orange-500 font-bold text-3xl">30+</div>
                    <div class="text-center">Publications</div>
                </div>
            </div>
        </div>
        <div class="w-full md:w-1/2">
            <img src="/team.webp" alt="Team" class="w-full h-full object-cover" />
        </div>
    </div>
</div>